...
{
    public class ManejadorPais : IManejador
    {
        ...
        public Tuple<bool, string> ValidarUsuario(string uno, string dos)
        {
            bool error = true;
            ...
            {
                cadenaErrores = cadenaErrores + "El campo Nclubes no puede ser vacio";
                error = false;
            }
        
            if (dos == "0")
            {
                cadenaErrores = cadenaErrores + "Nclubes debe ser mayor a 0";
                error = false;
